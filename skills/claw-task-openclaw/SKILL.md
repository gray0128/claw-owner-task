...
```bash
# 修改标题
claw-task update 5 -t "新标题" --json

# 修改优先级和截止日期
claw-task update 5 -p high --due "2026-03-20 17:00:00" --json

# 修改状态
claw-task update 5 -s archived --json

# 覆盖标签
claw-task update 5 --tags "工作,紧急" --json
```
